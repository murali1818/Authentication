      ...
      {user && (
        <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-xl font-bold text-purple-700">{user.name}</h1>
            <p className="text-gray-600">{user.email}</p>
          </div>
          <div className="flex flex-col items-center">
            <button
              onClick={() => setIsEditing(!isEditing)}
              className="bg-purple-500 text-white py-2 px-4 rounded mb-2 hover:bg-purple-600"
            >
              Edit Profile
            </button>
            <button
          ...
          {isEditing && (
            <form onSubmit={handleEditProfile} className="mt-4 w-full">
              ...
              <div className="flex justify-between">
                <button type="submit" className="bg-purple-700 text-white py-2 px-4 rounded hover:bg-purple-800">Save Changes</button>
          ...
          {isChangingPassword && (
            <form onSubmit={handleChangePassword} className="mt-4 w-full">
              ...
              <div className="flex justify-between">
                <button type="submit" className="bg-purple-700 text-white py-2 px-4 rounded hover:bg-purple-800">Change Password</button>
